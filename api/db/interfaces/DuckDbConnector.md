---
url: 'https://sqlrooms.org/api/db/interfaces/DuckDbConnector.md'
---
[@sqlrooms/db](../index.md) / DuckDbConnector
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `table` | `Uint8Array`<`ArrayBufferLike`> | `Table`<`any`> | Arrow table or arrow IPC stream to load |
| `tableName` | `string` | Name of the table to create |
| `opts?` | { `schema?`: `string`; } | - |
| `opts.schema?` | `string` | - |
