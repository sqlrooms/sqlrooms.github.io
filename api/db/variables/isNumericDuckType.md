---
url: 'https://sqlrooms.org/api/db/variables/isNumericDuckType.md'
---
[@sqlrooms/db](../index.md) / isNumericDuckType

# Variable: isNumericDuckType

> `const` **isNumericDuckType**: (`type`) => `boolean`
