---
url: 'https://sqlrooms.org/api/db/functions/load.md'
---
[@sqlrooms/db](../index.md) / load
...
| ------ | ------ | ------ |
| `method` | `"auto"` | `"read_json"` | `"read_ndjson"` | `"read_parquet"` | `"read_csv"` | `"st_read"` | The DuckDB read method to use (e.g., 'read\_csv', 'read\_json') |
