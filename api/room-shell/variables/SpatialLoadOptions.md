---
url: 'https://sqlrooms.org/api/room-shell/variables/SpatialLoadOptions.md'
---
[@sqlrooms/room-shell](../index.md) / SpatialLoadOptions

# Variable: SpatialLoadOptions

> `const` **SpatialLoadOptions**: `z.ZodObject`<[`SpatialLoadOptions`](../type-aliases/SpatialLoadOptions.md)>
