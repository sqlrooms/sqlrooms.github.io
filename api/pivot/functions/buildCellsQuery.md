---
url: 'https://sqlrooms.org/api/pivot/functions/buildCellsQuery.md'
---
[@sqlrooms/pivot](../index.md) / buildCellsQuery

# Function: buildCellsQuery()

> **buildCellsQuery**(`config`, `source`): `string`
