---
url: 'https://sqlrooms.org/api/pivot/functions/buildGrandTotalQuery.md'
---
[@sqlrooms/pivot](../index.md) / buildGrandTotalQuery

# Function: buildGrandTotalQuery()

> **buildGrandTotalQuery**(`config`, `source`): `string`
