---
url: 'https://sqlrooms.org/api/pivot/functions/normalizePivotConfig.md'
---
[@sqlrooms/pivot](../index.md) / normalizePivotConfig

# Function: normalizePivotConfig()

> **normalizePivotConfig**(`config`, `fields`): `object`
...
| `fields` | [`PivotField`](../type-aliases/PivotField.md)\[] |
