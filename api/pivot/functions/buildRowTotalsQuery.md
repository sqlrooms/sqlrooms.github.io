---
url: 'https://sqlrooms.org/api/pivot/functions/buildRowTotalsQuery.md'
---
[@sqlrooms/pivot](../index.md) / buildRowTotalsQuery

# Function: buildRowTotalsQuery()

> **buildRowTotalsQuery**(`config`, `source`): `string`
