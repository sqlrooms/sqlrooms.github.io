---
url: >-
  https://sqlrooms.org/api/pivot/functions/removeAttributeFilterValuesInConfig.md
---
[@sqlrooms/pivot](../index.md) / removeAttributeFilterValuesInConfig

# Function: removeAttributeFilterValuesInConfig()

> **removeAttributeFilterValuesInConfig**(`config`, `attribute`, `values`): `object`
