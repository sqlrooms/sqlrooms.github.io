---
url: 'https://sqlrooms.org/api/pivot/functions/buildColTotalsQuery.md'
---
[@sqlrooms/pivot](../index.md) / buildColTotalsQuery

# Function: buildColTotalsQuery()

> **buildColTotalsQuery**(`config`, `source`): `string`
