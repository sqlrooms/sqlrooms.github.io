---
url: 'https://sqlrooms.org/api/pivot/functions/setAttributeFilterValuesInConfig.md'
---
[@sqlrooms/pivot](../index.md) / setAttributeFilterValuesInConfig

# Function: setAttributeFilterValuesInConfig()

> **setAttributeFilterValuesInConfig**(`config`, `attribute`, `values`): `object`
