---
url: 'https://sqlrooms.org/api/pivot/functions/addAttributeFilterValuesInConfig.md'
---
[@sqlrooms/pivot](../index.md) / addAttributeFilterValuesInConfig

# Function: addAttributeFilterValuesInConfig()

> **addAttributeFilterValuesInConfig**(`config`, `attribute`, `values`): `object`
