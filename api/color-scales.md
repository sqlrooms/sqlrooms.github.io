...
* [ContinuousSequentialScheme](/api/color-scales/type-aliases/ContinuousSequentialScheme.md)
* [ContinuousDivergingScheme](/api/color-scales/type-aliases/ContinuousDivergingScheme.md)
* [BinnedNumericScheme](/api/color-scales/type-aliases/BinnedNumericScheme.md)
* [CategoricalScheme](/api/color-scales/type-aliases/CategoricalScheme.md)
* [ColorScaleScheme](/api/color-scales/type-aliases/ColorScaleScheme.md)
* [RGBAColor](/api/color-scales/type-aliases/RGBAColor.md)
* [ResolvedRGBA](/api/color-scales/type-aliases/ResolvedRGBA.md)
* [ColorScaleValue](/api/color-scales/type-aliases/ColorScaleValue.md)
* [ColorLegendConfig](/api/color-scales/type-aliases/ColorLegendConfig.md)
* [ColorScaleConfig](/api/color-scales/type-aliases/ColorScaleConfig.md)
* [ResolvedColorLegend](/api/color-scales/type-aliases/ResolvedColorLegend.md)
* [ColorScaleKind](/api/color-scales/type-aliases/ColorScaleKind.md)

## Variables

* [continuousSequentialSchemes](/api/color-scales/variables/continuousSequentialSchemes.md)
* [continuousDivergingSchemes](/api/color-scales/variables/continuousDivergingSchemes.md)
* [binnedNumericSchemes](/api/color-scales/variables/binnedNumericSchemes.md)
* [categoricalSchemes](/api/color-scales/variables/categoricalSchemes.md)
* [continuousSequentialInterpolators](/api/color-scales/variables/continuousSequentialInterpolators.md)
* [continuousDivergingInterpolators](/api/color-scales/variables/continuousDivergingInterpolators.md)
* [categoricalSchemeColors](/api/color-scales/variables/categoricalSchemeColors.md)
* [RGBAColor](/api/color-scales/variables/RGBAColor.md)
* [ColorLegendConfig](/api/color-scales/variables/ColorLegendConfig.md)
* [ColorScaleConfig](/api/color-scales/variables/ColorScaleConfig.md)

## Functions

* [ColorScaleLegend](/api/color-scales/functions/ColorScaleLegend.md)
* [coerceFiniteNumber](/api/color-scales/functions/coerceFiniteNumber.md)
* [normalizeColor](/api/color-scales/functions/normalizeColor.md)
* [parseColorString](/api/color-scales/functions/parseColorString.md)
* [resolveColorLegendTitle](/api/color-scales/functions/resolveColorLegendTitle.md)
* [isContinuousColorScale](/api/color-scales/functions/isContinuousColorScale.md)
* [isSteppedColorScale](/api/color-scales/functions/isSteppedColorScale.md)
* [isCategoricalColorScale](/api/color-scales/functions/isCategoricalColorScale.md)
* [getDiscreteNumericColors](/api/color-scales/functions/getDiscreteNumericColors.md)
* [getSequentialDomain](/api/color-scales/functions/getSequentialDomain.md)
* [getDivergingDomain](/api/color-scales/functions/getDivergingDomain.md)
* [createColorScaleMapper](/api/color-scales/functions/createColorScaleMapper.md)
* [buildColorScaleLegend](/api/color-scales/functions/buildColorScaleLegend.md)
