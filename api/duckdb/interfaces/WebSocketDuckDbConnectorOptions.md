---
url: 'https://sqlrooms.org/api/duckdb/interfaces/WebSocketDuckDbConnectorOptions.md'
---
...
| Parameter | Type |
| ------ | ------ |
| `status` | [`WebSocketDuckDbConnectionStatus`](../type-aliases/WebSocketDuckDbConnectionStatus.md) |
