---
url: 'https://sqlrooms.org/api/duckdb/interfaces/WebSocketDuckDbConnector.md'
---
[@sqlrooms/duckdb](../index.md) / WebSocketDuckDbConnector

# Interface: WebSocketDuckDbConnector
...
> `readonly` **connectionStatus**: [`WebSocketDuckDbConnectionStatus`](../type-aliases/WebSocketDuckDbConnectionStatus.md)
