...
> `const` **EditableText**: `FC`<{ `className?`: `string`; `isReadOnly?`: `boolean`; `value`: `string`; `placeholder?`: `string`; `onChange`: (`text`) => `void`; `defaultEditing?`: `boolean`; `isEditing?`: `boolean`; `onEditingChange?`: (`isEditing`) => `void`; }>
