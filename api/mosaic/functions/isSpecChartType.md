---
url: 'https://sqlrooms.org/api/mosaic/functions/isSpecChartType.md'
---
[@sqlrooms/mosaic](../index.md) / isSpecChartType

# Function: isSpecChartType()

> **isSpecChartType**<`TConfig`>(`chartType`): `chartType is SpecChartTypeDefinition<TConfig>`
