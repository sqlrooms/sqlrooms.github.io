...
> **setSelectedTable**: (`tableName`) => `void` | `Promise`<`void`>
...
> **updatePanel**(`panelId`, `patch`): `void` | `Promise`<`void`>
...
> **removePanel**(`panelId`): `void` | `Promise`<`void`>
...
> **addPanel**(`panel`): `string` | `Promise`<`string`>
