---
url: 'https://sqlrooms.org/api/sql-editor/type-aliases/CreateTableModalProps.md'
---
...
> `optional` **onAddOrUpdateSqlQuery?**: (`tableName`, `query`, `oldTableName?`, `abortSignal?`) => `Promise`<`void`>
