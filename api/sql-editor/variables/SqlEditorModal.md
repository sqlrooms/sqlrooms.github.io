---
url: 'https://sqlrooms.org/api/sql-editor/variables/SqlEditorModal.md'
---
[@sqlrooms/sql-editor](../index.md) / SqlEditorModal

# Variable: SqlEditorModal

> `const` **SqlEditorModal**: `React.FC`<[`SqlEditorProps`](../type-aliases/SqlEditorProps.md)>
