---
url: 'https://sqlrooms.org/api/room-config/variables/LoadFileOptions.md'
---
[@sqlrooms/room-config](../index.md) / LoadFileOptions

# Variable: LoadFileOptions

> `const` **LoadFileOptions**: `ZodDiscriminatedUnion`<[`LoadFileOptions`](../type-aliases/LoadFileOptions.md)>
