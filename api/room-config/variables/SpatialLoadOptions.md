---
url: 'https://sqlrooms.org/api/room-config/variables/SpatialLoadOptions.md'
---
[@sqlrooms/room-config](../index.md) / SpatialLoadOptions

# Variable: SpatialLoadOptions

> `const` **SpatialLoadOptions**: `ZodObject`<[`SpatialLoadOptions`](../type-aliases/SpatialLoadOptions.md)>
