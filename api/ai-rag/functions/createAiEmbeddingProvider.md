---
url: 'https://sqlrooms.org/api/ai-rag/functions/createAiEmbeddingProvider.md'
---
...
| `getApiKey?` | () => `string` | `undefined` | Optional function to retrieve API key at runtime (for dynamic provider factories) |
