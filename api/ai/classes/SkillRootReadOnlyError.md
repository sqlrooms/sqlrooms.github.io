---
url: 'https://sqlrooms.org/api/ai/classes/SkillRootReadOnlyError.md'
---
[@sqlrooms/ai](../index.md) / SkillRootReadOnlyError
...
> **new SkillRootReadOnlyError**(`message`, `context?`): `SkillRootReadOnlyError`
