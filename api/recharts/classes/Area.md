...
|  `getBaseValue` | `static` | (`props`, `item`, `xAxis`, `yAxis`) => `number` | - | - | - |
|  `getComposedData` | `static` | (`__namedParameters`) => `object` | - | - | - |
|  `renderDotItem` | `static` | (`option`, `props`) => `Element` | - | - | - |
...
| `baseLine` | `number` | `Coordinate`\[] | `undefined` |
| `needClip` | `boolean` |
| `clipPathId` | `string` |
