...
|  `parseDeltaAngle` | `static` | (`startAngle`, `endAngle`) => `number` | - | - | - |
|  `getRealPieData` | `static` | (`itemProps`) => `any`\[] | - | - | - |
|  `parseCoordinateOfPie` | `static` | (`itemProps`, `offset`) => `object` | - | - | - |
|  `getComposedData` | `static` | (`__namedParameters`) => `Omit`<[`PieProps`](../type-aliases/PieProps.md), `"dataKey"`> | - | - | - |
