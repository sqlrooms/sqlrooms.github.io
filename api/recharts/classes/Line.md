...
|  `getComposedData` | `static` | (`props`) => `object` | Compose the data of each group | - | - |
|  `mainCurve?` | `public` | `SVGPathElement` | - | - | - |
|  `state` | `public` | `State` | - | `PureComponent.state` | - |
|  `generateSimpleStrokeDasharray` | `public` | (`totalLength`, `length`) => `string` | - | - | - |
|  `getStrokeDasharray` | `public` | (`length`, `totalLength`, `lines`) => `string` | - | - | - |
|  `id` | `public` | `string` | - | - | - |
|  `pathRef` | `public` | (`node`) => `void` | - | - | - |
