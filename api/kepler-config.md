...
* [KeplerMapSchema](/api/kepler-config/type-aliases/KeplerMapSchema.md)
* [KeplerSliceConfig](/api/kepler-config/type-aliases/KeplerSliceConfig.md)
* [KeplerTabsArtifactsMigrationOptions](/api/kepler-config/type-aliases/KeplerTabsArtifactsMigrationOptions.md)

## Variables

* [KeplerMapSchema](/api/kepler-config/variables/KeplerMapSchema.md)
* [KeplerSliceConfig](/api/kepler-config/variables/KeplerSliceConfig.md)

## Functions

* [migrateKeplerTabsToArtifacts](/api/kepler-config/functions/migrateKeplerTabsToArtifacts.md)
