---
url: 'https://sqlrooms.org/api/ai-core/variables/isAnalysisSessionEmpty.md'
---
[@sqlrooms/ai-core](../index.md) / isAnalysisSessionEmpty

# ~~Variable: isAnalysisSessionEmpty~~

> `const` **isAnalysisSessionEmpty**: (`session`) => `boolean` = `isChatSessionEmpty`
...
Use `isChatSessionEmpty` instead.
