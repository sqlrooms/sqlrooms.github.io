---
url: 'https://sqlrooms.org/api/ai-core/variables/SessionControls.md'
---
[@sqlrooms/ai-core](../index.md) / SessionControls

# Variable: SessionControls

> `const` **SessionControls**: `React.FC`<{ `className?`: `string`; `children?`: `React.ReactNode`; }>
